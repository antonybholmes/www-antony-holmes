      ...
      <Container>
        <MainSideCol>
          <>
            ...
            <p>
              The Polite Investor takes your privacy seriously. We collect as
              little information about you as possible. Such data that we might
              collect, we will not sell, lease, exchange, or otherwise share
              with third parties in ways other than described in this Privacy
              Policy. If you have additional questions or require more
            ...
            <p>
              ...
              services. These cookies are used to store information including
              the pages on the website that the visitor accessed or visited. For
              more general information on cookies, please read{" "}
              <ColorLink
                color="blue"
            ...
            <p>
              The Polite Investor's Privacy Policy does not apply to other
            ...
            <p>
              Note that we have no access or control over cookies that are used
          ...
          <p>
            ...
            <p>
              When you visit this site we may use cookies, server logs, and
              other methods to collect anonymous data about what pages you visit
              and when.
            </p>

            <h2 className="mt-8">Do you share data with others?</h2>
            <p>
              We do not collect or give information about you to other companies
              or services. However, we do use services from other companies to
              provide this site. The companies behind those services may collect
              data about you on their own, for their own purposes. Some of these
              services may be used to collect information about your online
            ...
            <table className="bg-white w-full mt-4">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="p-4 border">
                    Provides cloud servers and services for running this
                    website.
                  </td>
                </tr>
