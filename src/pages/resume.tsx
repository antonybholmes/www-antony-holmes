      ...
      <Container>
        ...
        <Row isVCentered={false} wrap={true} className="mb-8">
          ...
          <section className="w-full  border border-solid border-gray-200 rounded-md overflow-hidden">
            ...
            <ul className="m-3 list-inside list-disc">
              ...
              <li className="mb-1">
                Served as AWS administrator and full stack developer for our
                group working on database and web applications using S3, EC2,
                Cloudfront for deployment to a team of 20 people.
              </li>
              <li className="mb-1">
        ...
        <Row isVCentered={false} wrap={true} className="mb-8">
          ...
          <div className="w-full  border border-solid border-gray-200 rounded-md">
            ...
            <ul className="m-3 list-inside list-disc">
              <li className="mb-1">
                Worked as the lead Bioinformatician and software developer in
                the lab of Riccardo Dalla-Favera.
              </li>
              <li className="mb-1">
              ...
              <li className="mb-1">
                Reduced data analysis time on many projects from days to hours
                by bringing data analysis in house and standardizing processes
                and methods.
              </li>
              <li className="mb-1">
                Implemented data pipelines to process and analyze next
                generation sequencing data including microarray, SNP 6.0,
                RNA-seq, Chip-seq, and single cell genomic data.
              </li>
              <li className="mb-1">
                Developed a suite of open source applications in Java for
                biological data analysis with easy to use interfaces to allow
                non computational scientists to do common tasks including
                performing statistical analysis and visualizing large data sets.
              </li>
              <li className="mb-1">
                My work resulted resulted in the publication of more than 16
                research papers in journals including Nature, Cell, Blood, and
                the New England Journal of Medicine, primary focussed on B-cell
          ...
          <div className="w-full  border border-solid border-gray-200 rounded-md">
            ...
            <ul className="m-3 list-inside list-disc">
              <li className="mb-1">
                ...
                Presbyterian Hospital. Looked for novel relationships between
                rare diseases and comorbidities to find potential avenues for
              ...
              <li className="mb-1">
                ...
                database for data mining purposes within our group. This was
                used by the lab over a 5 year period beyond when I left the lab.
              </li>
              <li className="mb-1">
        ...
        <Row isVCentered={false} wrap={true} className="mb-8">
          ...
          <div className="w-full  border border-solid border-gray-200 rounded-md">
            ...
            <p className="m-3">
              I designed data pipelines for processing single cell RNA-seq data
              as well as specialized biology application development, database
              administration, and REST based web application development.
            </p>
            <ul className="m-3 list-inside list-disc">
              <li className="mb-1">
        ...
        <Row isVCentered={false} wrap={true} className="mb-8">
          ...
          <section className="w-full  border border-solid border-gray-200 rounded-md overflow-hidden">
            ...
            <ul className="m-3 list-inside list-disc">
              ...
              <li className="mb-1">
                Prepare and file federal and state tax forms for up to 200
                clients each tax season saving clients $100,000 in preparation
                fees.
              </li>
              <li className="mb-1">
