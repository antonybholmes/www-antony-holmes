  ...
  >
    <FlHdDiv>
      <Container>
        <MainSideCol>
          <>
            <h1>Polite Investor Website Terms of Use</h1>
            <h2 className="mt-8">
              Ownership of Site and Agreement to Terms of Use
            </h2>
            <p>
              These Terms and Conditions of Use (the "Terms of Use") apply to
              the Polite Investor (the "Institute") website (the "Site"). The
              Site is the property of the Institute. BY USING THE SITE, YOU
              AGREE TO THESE TERMS OF USE; IF YOU DO NOT AGREE, DO NOT USE THE
              SITE.
            </p>
            <p>
              The Polite Investor reserves the right, at its sole discretion, to
              ...
              changes. As long as you comply with these Terms of Use, we grant
            ...
            <p>
              ...
              feel" and arrangement of such Content, contained on the Site is
              owned, controlled or licensed by or to the Institute, and is
            ...
            <p>
              ...
              without the Institute’s express prior written consent. You may use
              information from the Site, provided that you (1) not remove any
            ...
            <h2 className="mt-8">Your Use of the Site</h2>
            <p>
              ...
              offered on or through the Site, by hacking, password "mining" or
            ...
            <p>
              ...
              or attempt to interfere with the proper working of the Site or
            ...
            <p>
              ...
              a convenience to our visitors. Such Linked Sites are not under the
            ...
            <h2 className="mt-8">Privacy</h2>
            <p>
              The Polite Investor's Privacy Policy applies to use of this Site,
              and its terms are made a part of these Terms of Use by this
              reference. To view the Polite Investor' Privacy Policy,{" "}
            ...
            <h2 className="mt-8">Disclaimers</h2>
            <p>
              ...
              NOTICE. THE POLITE INVESTOR CANNOT ENSURE THAT ANY FILES OR OTHER
              DATA YOU DOWNLOAD FROM THE SITE WILL BE FREE OF VIRUSES OR
              CONTAMINATION OR DESTRUCTIVE FEATURES. THE POLITE INVESTOR
              ...
              SITE. YOU ASSUME TOTAL RESPONSIBILITY FOR YOUR USE OF THE SITE AND
              ANY LINKED SITES. YOUR SOLE REMEDY AGAINST THE POLITE INVESTOR FOR
              DISSATISFACTION WITH THE SITE OR ANY CONTENT IS TO STOP USING THE
              SITE OR ANY SUCH CONTENT. THIS LIMITATION OF RELIEF IS A PART OF
            ...
            <h2 className="mt-8">Indemnity</h2>
            <p>
              You shall indemnify, defend and hold harmless the Institute and
              its officers, directors and employees, from and against all third
              party claims, losses, damages, costs and liabilities, including
              reasonable attorneys’ fees, arising out of or relating to your use
              of the Website, your use of the Services, your Content, or any
              products or services offered by you to a third party, or obtained
              by you from a third party, via the Site.
            </p>

            <h2 className="mt-8">Limited Liability</h2>
            <p>
              ...
              WEBSITE OR ANY SOFTWARE, SERVICES OR CONTENT ON THE WEBSITE,
              WHETHER AS A RESULT OF BREACH OF CONTRACT, TORT (INCLUDING
              NEGLIGENCE) OR OTHERWISE, REGARDLESS OF THE THEORY OF LIABILITY,
              IS LIMITED TO NO MORE THAN THE LESSER OF (A) THE TOTAL FEES PAID
              BY YOU IN THE THEN-CURRENT MONTH OR (B) ONE HUNDRED DOLLARS (US
              $100).
            </p>

            <p>
              IN ADDITION, THE POLITE INVESTOR WILL NOT UNDER ANY CIRCUMSTANCES
              BE LIABLE FOR LOST PROFITS, CONSEQUENTIAL, INDIRECT, PUNITIVE,
              EXEMPLARY OR SPECIAL DAMAGES.
            </p>

            <h2 className="mt-8">Governing Law</h2>
            <p>
              This Agreement shall be governed and construed in accordance with
              the laws of the State of New York without giving effect to
              conflict of law principles. You and the Institute agree to submit
              to the personal and exclusive jurisdiction of the state and
              federal courts located within New York for the purpose of
