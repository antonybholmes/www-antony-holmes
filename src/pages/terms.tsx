...
const TermsPage = () => {
  ...
  return (
    <ArticleLayout title="Terms of Use">
      <h1>Terms of Use</h1>
      ...
      <p>
        ...
        trademarks, logos, artwork and computer code (collectively, "Content"),
        including but not limited to the design, structure, selection,
        coordination, expression, "look and feel" and arrangement of such
        Content, contained on the Site is owned, controlled or licensed by or to
        the {siteName}, and is protected by trade dress, copyright, patent and
      ...
      <p>
        ...
        enterprise, without the Institute’s express prior written consent. You
        may use information from the Site, provided that you (1) not remove any
        ...
        computer or broadcast it in any media, (3) make no modifications to any
        such information, and (4) not make any additional representations
      ...
      <p>
        ...
        Site or to any Institute server, or to any of the services offered on or
      ...
      <p>
        ...
        any systems or networks connected to the Site or to the Institute.
      </p>
      <p>
      ...
      <p>
        ...
        Institute's control, and we are not responsible for and does not endorse
        the content of such Linked Sites, including any information or materials
      ...
      <p>
        {siteName.toUpperCase()} DOES NOT PROMISE THAT THE SITE OR ANY CONTENT,
        SERVICE OR FEATURE OF THE SITE WILL BE ERROR-FREE OR UNINTERRUPTED, OR
        THAT ANY DEFECTS WILL BE CORRECTED, OR THAT YOUR USE OF THE SITE WILL
        PROVIDE SPECIFIC RESULTS. THE SITE AND ITS CONTENT ARE DELIVERED ON AN
        "AS-IS" AND "AS-AVAILABLE" BASIS. ALL INFORMATION PROVIDED ON THE SITE
        IS SUBJECT TO CHANGE WITHOUT NOTICE. {siteName.toUpperCase()} CANNOT
        ...
        {siteName.toUpperCase()} DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED,
        INCLUDING ANY WARRANTIES OF ACCURACY, NON-INFRINGEMENT, MERCHANTABILITY
        AND FITNESS FOR A PARTICULAR PURPOSE. {siteName.toUpperCase()} DISCLAIMS
        ...
        ASSUME TOTAL RESPONSIBILITY FOR YOUR USE OF THE SITE AND ANY LINKED
        SITES. YOUR SOLE REMEDY AGAINST {siteName.toUpperCase()} FOR
        DISSATISFACTION WITH THE SITE OR ANY CONTENT IS TO STOP USING THE SITE
        OR ANY SUCH CONTENT. THIS LIMITATION OF RELIEF IS A PART OF THE BARGAIN
        BETWEEN THE PARTIES.
      </p>
      <p>
      ...
      <p>
        ...
        your use of the Services, your Content, or any products or services
        offered by you to a third party, or obtained by you from a third party,
        via the Site.
      </p>
      <h2 className="mt-8 uppercase">Limited Liability</h2>
      <p>
        {siteName.toUpperCase()}’S AGGREGATE LIABILITY FOR ALL CLAIMS, LOSSES,
        LIABILITIES OR DAMAGES IN CONNECTION WITH THIS AGREEMENT, YOUR ACCESS TO
        OR USE OF, OR YOUR INABILITY TO ACCESS OR USE, THE WEBSITE OR ANY
        ...
        OF THE THEORY OF LIABILITY, IS LIMITED TO NO MORE THAN THE LESSER OF (A)
        THE TOTAL FEES PAID BY YOU IN THE THEN-CURRENT MONTH OR (B) ONE HUNDRED
        DOLLARS (US $100).
      </p>
      <p>
        IN ADDITION, {siteName.toUpperCase()} WILL NOT UNDER ANY CIRCUMSTANCES
        BE LIABLE FOR LOST PROFITS, CONSEQUENTIAL, INDIRECT, PUNITIVE, EXEMPLARY
        OR SPECIAL DAMAGES.
      </p>
