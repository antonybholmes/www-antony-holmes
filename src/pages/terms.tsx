    ...
    <PageLayout title="Terms of Use">
      <Container>
        ...
        <p>
          ...
          {siteName} website (the "Site"). The Site is the property of the{" "}
          {siteName}. BY USING THE SITE, YOU AGREE TO THESE TERMS OF USE; IF YOU
          DO NOT AGREE, DO NOT USE THE SITE.
        </p>
        <p>
          {siteName} reserves the right, at its sole discretion, to change,
          modify, add or remove portions of these Terms of Use, at any time. It
          is your responsibility to check these Terms of Use periodically for
          changes. Your continued use of the Site following the posting of
        ...
        <p>
          ...
          licensed by or to the {siteName}, and is protected by trade dress,
        ...
        <p>
          ...
          server, Web site or other medium for publication or distribution or
          for any commercial enterprise, without the Institute’s express prior
          written consent. You may use information from the Site, provided that
          you (1) not remove any proprietary notice language in all copies of
          ...
          (3) make no modifications to any such information, and (4) not make
          any additional representations relating to such documents.
        </p>
        ...
        <p>
          ...
          Site or to any Institute server, or to any of the services offered on
          or through the Site, by hacking, password "mining" or any other
          illegitimate means.
        </p>
        <p>
        ...
        <p>
          ...
          the Site, or any systems or networks connected to the Site or to the
          Institute.
        </p>
        <p>
        ...
        <p>
          ...
          materials contained on such Linked Sites. You will need to make your
          own independent judgment regarding your interaction with these Linked
          Sites.
        </p>
        <h2 className="mt-8 uppercase">Privacy</h2>
        <p>
          {siteName}'s Privacy Policy applies to use of this Site, and its terms
          are made a part of these Terms of Use by this reference. To view the{" "}
          {siteName}' Privacy Policy,{" "}
          <BlueLink to="/privacy">click here</BlueLink>. Additionally, by using
          the Site, you acknowledge and agree that Internet transmissions are
        ...
        <p>
          {siteName.toUpperCase()} DOES NOT PROMISE THAT THE SITE OR ANY
          ...
          OF THE SITE WILL PROVIDE SPECIFIC RESULTS. THE SITE AND ITS CONTENT
          ARE DELIVERED ON AN "AS-IS" AND "AS-AVAILABLE" BASIS. ALL INFORMATION
          PROVIDED ON THE SITE IS SUBJECT TO CHANGE WITHOUT NOTICE.{" "}
          {siteName.toUpperCase()} CANNOT ENSURE THAT ANY FILES OR OTHER DATA
          YOU DOWNLOAD FROM THE SITE WILL BE FREE OF VIRUSES OR CONTAMINATION OR
          DESTRUCTIVE FEATURES. {siteName.toUpperCase()} DISCLAIMS ALL
          WARRANTIES, EXPRESS OR IMPLIED, INCLUDING ANY WARRANTIES OF ACCURACY,
          NON-INFRINGEMENT, MERCHANTABILITY AND FITNESS FOR A PARTICULAR
          PURPOSE. {siteName.toUpperCase()} DISCLAIMS ANY AND ALL LIABILITY FOR
          THE ACTS, OMISSIONS AND CONDUCT OF ANY THIRD PARTIES IN CONNECTION
          WITH OR RELATED TO YOUR USE OF THE SITE. YOU ASSUME TOTAL
          RESPONSIBILITY FOR YOUR USE OF THE SITE AND ANY LINKED SITES. YOUR
          SOLE REMEDY AGAINST {siteName.toUpperCase()} FOR DISSATISFACTION WITH
          THE SITE OR ANY CONTENT IS TO STOP USING THE SITE OR ANY SUCH CONTENT.
        ...
        <p>
          {siteName} reserves the right to do any of the following, at any time,
          ...
          the Site, or any portion of the Site, as necessary to perform routine
          or non-routine maintenance, error correction, or other changes.
        </p>
        <h2 className="mt-8 uppercase">Indemnity</h2>
        <p>
          You shall indemnify, defend and hold harmless {siteName} and its
        ...
        <p>
          {siteName.toUpperCase()}’S AGGREGATE LIABILITY FOR ALL CLAIMS, LOSSES,
          LIABILITIES OR DAMAGES IN CONNECTION WITH THIS AGREEMENT, YOUR ACCESS
          TO OR USE OF, OR YOUR INABILITY TO ACCESS OR USE, THE WEBSITE OR ANY
          SOFTWARE, SERVICES OR CONTENT ON THE WEBSITE, WHETHER AS A RESULT OF
          BREACH OF CONTRACT, TORT (INCLUDING NEGLIGENCE) OR OTHERWISE,
          REGARDLESS OF THE THEORY OF LIABILITY, IS LIMITED TO NO MORE THAN THE
          LESSER OF (A) THE TOTAL FEES PAID BY YOU IN THE THEN-CURRENT MONTH OR
          (B) ONE HUNDRED DOLLARS (US $100).
        </p>
        <p>
          IN ADDITION, {siteName.toUpperCase()} WILL NOT UNDER ANY CIRCUMSTANCES
          BE LIABLE FOR LOST PROFITS, CONSEQUENTIAL, INDIRECT, PUNITIVE,
